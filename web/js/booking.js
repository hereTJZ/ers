...
function date_time(date) {
    ...
    if (isThisWeek(rightNow, date)) {
        ...
        // js方式复原表头css样式
        if (weekday != 0) {
            document.getElementsByTagName("th")[weekday - 1].style = "background-color: #d4f0f3; color: #000000;";
        } else {
            // 周日
            document.getElementsByTagName("th")[6].style = "background-color: #d4f0f3; color: #000000;";
        }
    }
}
